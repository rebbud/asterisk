...
/* Limit the DTMF sequence to pause/resume recording to three digits */
...
/* Collect the DTMF digits received in this buffer */
...
struct sip_pvt {
	...
	struct dub_collect_dtmf dub_dtmf_store; /*!< Store the received DTMF pattern */
};
