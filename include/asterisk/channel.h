...
enum {
	...
	AST_FLAG_DUB_PAUSE_RESUME_RECORDING = (1 << 28), /*! DUB - Flag for pause / resume */
        AST_FLAG_DUB_RECORDING_CONTROL = (1 << 29),      /*! DUB - Flag for recroding call control */
        AST_FLAG_DUB_RECORD_SILENT_PAUSE = (1 << 30),    /*! DUB - Flag for inserting silence for paused call recording */
	AST_FLAG_DUB_SRTP_CALL = (1 << 31),              /*! DUB require SRTP call ( late negotiation) */
};
